...
these [docs](https://docs.dharitri.org/integrators/observing-squad/) 
...
can be found [here](https://github.com/TerraDharitri/drt-go-chain/blob/main/cmd/node/config/external.toml).
